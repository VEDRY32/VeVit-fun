...
const GAMES = [
  ...
  'mavnik', 'pexeso', 'ctyri-v-rade', 'cihlobijec', 'invaze', 'hladovec', 'bezec', 'piskvorky', 'odpal', 'sudoku', 'kostka', 'lovec-uzemi', 'super-skokan', 'utek', 'posledni-obrana', 'ohen-a-voda', 'najezdnik', 'stastna-opice', 'pruchody',
];
